...
const Sidebar = ({ navItems, portalName, variant = 'default' }: SidebarProps) => {
  ...
  return (
    <aside className={cn(
      ...
      isHod && "bg-hod-sidebar text-hod-sidebar-foreground" // Added text-hod-sidebar-foreground here
    )}>
      <div className={cn(
        ...
        isHod && "border-hod-sidebar-border"
      )}>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isHod && "text-hod-sidebar-muted-foreground hover:text-hod-sidebar-foreground", // Muted foreground for inactive
                isActive && (
                  ...
                  isHod ? "bg-hod-sidebar-active text-hod-sidebar-active-foreground" : // Active background and foreground
                  ""
                )
              )
            }
