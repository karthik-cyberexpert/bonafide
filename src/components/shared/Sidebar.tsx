...
const Sidebar = ({ navItems, portalName, variant = 'default' }: SidebarProps) => {
  ...
  return (
    <aside className={cn(
      ...
      isHod && "bg-hod-sidebar text-hod-sidebar-foreground"
    )}>
      <div className={cn(
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isHod && "text-hod-sidebar-muted-foreground hover:text-hod-sidebar-foreground",
                isActive && (
                  ...
                  isHod ? "bg-hod-sidebar-active text-hod-sidebar-active-foreground" :
                  ""
                )
              )
            }
